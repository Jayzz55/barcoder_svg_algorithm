defmodule BarcorderSvgAlgorithm do
  ...
  test
  ## Examples
      iex> BarcorderSvgAlgorithm.transform([0,1,1,1,0,0,0,1])
      [{1, 3}, {7, 1}]
  """
  ...
  test
  ## Examples
      iex> BarcorderSvgAlgorithm.first_transform([0,1,1,1,0,0,0,1])
      [{1, 1}, {2, 1}, {3, 1}, {7, 1}]
  """
  ...
  test
  ## Examples
      iex> BarcorderSvgAlgorithm.second_transform([{1, 1}, {2, 1}, {3, 1}, {7, 1}])
      [{1, 3}, {7, 1}]
  """
